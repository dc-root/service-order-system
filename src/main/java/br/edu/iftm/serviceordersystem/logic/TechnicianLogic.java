...
public class TechnicianLogic implements GenericLogic<Technician> {
    ...
    public void initializeData() {
        ...
        technician1.setIdentificationNumber("12345678900"); // Exemplo de CPF
        ...
        technician3.setIdentificationNumber("98765432100"); // Exemplo de CPF
        ...
        technician4.setIdentificationNumber("98765432000177"); // Exemplo de CNPJ
        ...
        technician5.setIdentificationNumber("23456789011"); // Exemplo de CPF
        ...
        technician6.setIdentificationNumber("23456789000133"); // Exemplo de CNPJ
